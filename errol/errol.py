...
def main(args):
    ...
    try:
        ...
        disam_file = os.path.join(full_path, (timestamp + '_grant_disambiguation.txt'))
        ...
        skips_file = os.path.join(full_path, (timestamp + '_grant_skips.txt'))
